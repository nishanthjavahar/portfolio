  ...
  return (
    <main className="min-h-screen bg-black text-white p-10">
      ...
      <section className="mb-20">
        ...
        <p className="mt-4 text-xl">Computer Science Engineering Student</p>
      ...
      <section className="mb-16">
        ...
        <div className="bg-gray-900 p-6 rounded-xl">
          ...
          <p className="text-gray-400 mt-2">
            Prototype platform to manage educational activities and internship
            coordination for Bannerghatta Biological Park.
          </p>
        </div>
      </section>
